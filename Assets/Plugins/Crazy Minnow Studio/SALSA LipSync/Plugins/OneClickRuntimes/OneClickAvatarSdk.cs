    ...
    public class OneClickAvatarSdk : OneClickBase
    {
        ...
        public static void Setup(GameObject gameObject)
        {
            ...
            NewConfiguration(OneClickConfiguration.ConfigType.Salsa);
            {
                ...
                NewExpression("f");
                AddShapeComponent(new[] { "FF" }, 0.08f, 0f, 0.08f, "viseme_FF", 0.006f * BlendshapeScale, true, "^.+Head$");
                AddShapeComponent(new[] { "FF" }, 0.08f, 0f, 0.08f, "viseme_FF_teeth", 0.008f * BlendshapeScale, true, "^.+TeethLower$");

                NewExpression("w");
                AddShapeComponent(new[] { "jawOpen" }, 0.08f, 0f, 0.08f, "jawOpen", 0.0015f * BlendshapeScale, true, "^.+Head$");
                AddShapeComponent(new[] { "jawOpen" }, 0.08f, 0f, 0.08f, "jawOpen_teeth", 0.0010f * BlendshapeScale, true, "^.+TeethLower$");
                AddShapeComponent(new[] { "mouthFunnel" }, 0.08f, 0f, 0.08f, "mouthFunnel", 0.0f * BlendshapeScale, true, "^.+Head$");
                AddShapeComponent(new[] { "mouthPucker" }, 0.08f, 0f, 0.08f, "mouthPucker", 0.0041f * BlendshapeScale, true, "^.+Head$");
                AddShapeComponent(new[] { "mouthUpperUpLeft" }, 0.08f, 0f, 0.08f, "mouthUpperUpLeft", 0.0075f * BlendshapeScale, true, "^.+Head$");
                AddShapeComponent(new[] { "mouthUpperUpRight" }, 0.08f, 0f, 0.08f, "mouthUpperUpRight", 0.0075f * BlendshapeScale, true, "^.+Head$");

                NewExpression("t");
                AddShapeComponent(new[] { "DD" }, 0.08f, 0f, 0.08f, "viseme_DD", 0.0054f * BlendshapeScale, true, "^.+Head$");
                AddShapeComponent(new[] { "DD" }, 0.08f, 0f, 0.08f, "viseme_DD_teeth", 0.007f * BlendshapeScale, true, "^.+TeethLower$");

                NewExpression("th");
                AddShapeComponent(new[] { "^TH$" }, 0.08f, 0f, 0.08f, "viseme_TH", 0.0095f * BlendshapeScale, true, "^.+Head$");
                AddShapeComponent(new[] { "jawOpen" }, 0.08f, 0f, 0.08f, "jawOpen", 0.0015f * BlendshapeScale, true, "^.+Head$");
                AddShapeComponent(new[] { "jawOpen" }, 0.08f, 0f, 0.08f, "jawOpen_teeth", 0.0015f * BlendshapeScale, true, "^.+TeethLower$");

                NewExpression("ow");
                AddShapeComponent(new[] { "mouthFunnel" }, 0.08f, 0f, 0.08f, "mouthFunnel", 0.00077f * BlendshapeScale, true, "^.+Head$");
                AddShapeComponent(new[] { "mouthPucker" }, 0.08f, 0f, 0.08f, "mouthPucker", 0.004f * BlendshapeScale, true, "^.+Head$");
                AddShapeComponent(new[] { "oh" }, 0.08f, 0f, 0.08f, "viseme_O", 0.004f * BlendshapeScale, true, "^.+Head$");             
                AddShapeComponent(new[] { "jawOpen" }, 0.08f, 0f, 0.08f, "jawOpen", 0.0029f * BlendshapeScale, true, "^.+Head$");
                AddShapeComponent(new[] { "jawOpen" }, 0.08f, 0f, 0.08f, "jawOpen_teeth", 0.0029f * BlendshapeScale, true, "^.+TeethLower$");

                NewExpression("ee");
                AddShapeComponent(new[] { "^mouthLeft$" }, 0.08f, 0f, 0.08f, "mouthLeft", 0.00422f * BlendshapeScale, true, "^.+Head$");
                AddShapeComponent(new[] { "^mouthRight$" }, 0.08f, 0f, 0.08f, "mouthRight", 0.00422f * BlendshapeScale, true, "^.+Head$");
                AddShapeComponent(new[] { "mouthSmileLeft" }, 0.08f, 0f, 0.08f, "mouthSmileL", 0.0052f * BlendshapeScale, true, "^.+Head$");
                AddShapeComponent(new[] { "mouthSmileRight" }, 0.08f, 0f, 0.08f, "mouthSmileR", 0.0052f * BlendshapeScale, true, "^.+Head$");
                AddShapeComponent(new[] { "jawOpen" }, 0.08f, 0f, 0.08f, "jawOpen", 0.0040f * BlendshapeScale, true, "^.+Head$");
                AddShapeComponent(new[] { "jawOpen" }, 0.08f, 0f, 0.08f, "jawOpen_teeth", 0.0040f * BlendshapeScale, true, "^.+TeethLower$");
                AddShapeComponent(new[] { "mouthStretchLeft" }, 0.08f, 0f, 0.08f, "mouthStretchLeft", 0.00571f * BlendshapeScale, true, "^.+Head$");
                AddShapeComponent(new[] { "mouthStretchRight" }, 0.08f, 0f, 0.08f, "mouthStretchRight", 0.0057f * BlendshapeScale, true, "^.+Head$");
                AddShapeComponent(new[] { "mouthLowerDownLeft" }, 0.08f, 0f, 0.08f, "mouthLowerDownLeft", 0.0013f * BlendshapeScale, true, "^.+Head$");
                AddShapeComponent(new[] { "mouthLowerDownRight" }, 0.08f, 0f, 0.08f, "mouthLowerDownRight", 0.0013f * BlendshapeScale, true, "^.+Head$");             
                AddShapeComponent(new[] { "mouthUpperUpLeft" }, 0.08f, 0f, 0.08f, "mouthUpperUpLeft", 0.0023f * BlendshapeScale, true, "^.+Head$");
                AddShapeComponent(new[] { "mouthUpperUpRight" }, 0.08f, 0f, 0.08f, "mouthUpperUpRight", 0.0022f * BlendshapeScale, true, "^.+Head$");

                NewExpression("oo");
                //AddShapeComponent(new[] { "mouthOpen" }, 0.08f, 0f, 0.08f, "mouthOpen", 0.00751f * BlendshapeScale, true, "^.+Head$");
                AddShapeComponent(new[] { "oh" }, 0.08f, 0f, 0.08f, "viseme_O", 0.0014f * BlendshapeScale, true, "^.+Head$");
                AddShapeComponent(new[] { "ou" }, 0.08f, 0f, 0.08f, "viseme_U", 0.0010f * BlendshapeScale, true, "^.+Head$");

                AddShapeComponent(new[] { "jawOpen" }, 0.08f, 0f, 0.08f, "jawOpen", 0.0045f * BlendshapeScale, true, "^.+Head$");
                AddShapeComponent(new[] { "jawOpen" }, 0.08f, 0f, 0.08f, "jawOpen_teeth", 0.0045f * BlendshapeScale, true, "^.+TeethLower$");
            }
